...
<details>
  ...
  <img src="https://github.com/user-attachments/assets/3ef38fd6-6fc4-46a2-b60f-844bc2517632">
</details>
...
~~~~db.properties
# Configuração do banco de dados (usuário e senha)
user=root
password=abc123.

# URL de conexão com o banco de dados
dburl=jdbc:mysql://localhost:3306/sgtg?useUnicode=true&amp&characterEncoding=UTF-8
...
<details>
  ...
  public class TelaFeedbackAlunoController implements Initializable {
  	...
  	public void onBtnSalvarAction() throws SQLException {
  		...
  		try {
  			...
  			if (nota > 10) {
  				Alerts.showAlert("Nota acima de 10", "Cuidado", "A nota máxima deve ser 10", AlertType.WARNING);
  			} else {
  
  				if (entrega_selecionada == null || comentario.trim().isEmpty()) {
  					Alerts.showAlert("Campo nulo", "Cuidado", "Todos os campos devem ser preenchidos",
  							AlertType.WARNING);
  				} else {
  					try {
  						...
  						Alerts.showAlert("Atenção", "Já foi dado um feedback para este aluno",
  								"Já foi atribuido um feedback para esta entrega", AlertType.INFORMATION);
  			...
  			Alerts.showAlert("Formato invalido!", "A nota foi dada no formato invalido!",
  					"Favor digite neste formato: 0.0", AlertType.INFORMATION);
  		}
  ...
  //		 TODO Auto-generated method stub
  		try {
  			...
  			listaEntrega = LoadEntregas.atualizarDadosComboBox(id_aluno_selecionada);// Oq eu preciso passar no
  																						// parenteses
  		} catch (SQLException e) {
...
<details>
  ...
  <img src="https://github.com/user-attachments/assets/99c962e2-1af1-496c-af63-93069c91f9c8">
</details>

<details>
  <summary>Detalhes Usuário</summary>

  <img src="https://github.com/user-attachments/assets/dac72805-67d1-4017-b469-354cfb74cfc7">
</details>
...
<details>
  ...
  <img src="https://github.com/user-attachments/assets/74fe31ec-720a-4175-84b1-0820b8b81beb">
</details>
...
<details>
  <summary>Detalhes do botão</summary>
